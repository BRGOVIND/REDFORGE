...
export function ForgeMark({ size = 28, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className} aria-hidden>
      <path className="forge-angle-top" d="M6 9 L16 4 L26 9" stroke="#55555F" strokeWidth="1.5" strokeLinecap="round" />
      <path className="forge-angle-bottom" d="M6 23 L16 28 L26 23" stroke="#55555F" strokeWidth="1.5" strokeLinecap="round" />
      <path
...
export function Wordmark({ className }: { className?: string }) {
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      <ForgeMark size={22} />
      <span className="forge-word display text-[15px] tracking-tight text-bone">
